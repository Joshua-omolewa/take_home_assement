...
* **SLOW EXTRACTION**: Initial version of my python script was slow for extraction of book data from raw data initally extraced from the API. I had to implement concurrency (using Threadpool executor) to speed up the extraction process utilizing multiple threads .  I followed this ariticle **[here](https://medium.com/@superfastpython/python-threadpoolexecutor-7-day-crash-course-78d4846d5acc )**
*  
